...
public interface ILineaAsientoRepository
{
    ...
    Task<List<LineaAsiento>> ObtenerParaEstadoResultados(Guid clienteId, DateOnly fechaDesde, DateOnly fechaHasta);
    Task<List<LineaAsiento>> ObtenerParaBalanceGeneral(Guid clienteId, DateOnly fechaHasta);
    Task<List<LineaAsiento>> ObtenerParaLiquidacionIva(Guid clienteId, DateOnly fechaDesde, DateOnly fechaHasta);
