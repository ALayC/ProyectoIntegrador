...
builder.Services.AddScoped<IBalanceGeneralExcelService, BalanceGeneralExcelService>();
builder.Services.AddScoped<IBalanceGeneralPdfService, BalanceGeneralPdfService>();
